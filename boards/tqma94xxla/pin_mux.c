...
void BOARD_InitPins(void)
{
...
#else
    /* Configuration of different debug UART is not supported for this board */
    #error
#endif
    ...
    IOMUXC_SetPinConfig(IOMUXC_PAD_I2C1_SDA__LPI2C1_SDA, IOMUXC_PAD_DSE(0xFU)
        | IOMUXC_PAD_FSEL1(0x3U) | IOMUXC_PAD_PU(0x1U) | IOMUXC_PAD_OD(0x1U));
#else
    /* Configuration of different system I2C is not supported for this board */
    #error
#endif

    /* Configure GPIO1-8 (INT from the PMIC) */
    IOMUXC_SetPinMux(IOMUXC_PAD_PDM_CLK__GPIO1_IO8, 0U);
    IOMUXC_SetPinConfig(IOMUXC_PAD_PDM_CLK__GPIO1_IO8, IOMUXC_PAD_PU(0x1U));
}
