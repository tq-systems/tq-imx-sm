...
Most messages that are part of the vendor extension protocols are mandatory. If the protocol is
supported, the message will be supported. In some cases, an entire protocol might be optional
(e.g. BBM if there is no BBNSM module or equivalent in an SoC).

| Protocol | Protocol<BR>ID | Message | Message<BR>ID | Access<BR>Control | Mandatory |
|---|---|---|---|---|---|
| Base | 0x10 | [PROTOCOL_VERSION](@ref SCMI_PROTO_BASE_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Base | 0x10 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_BASE_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Base | 0x10 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_BASE_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Base | 0x10 | [BASE_DISCOVER_VENDOR](@ref SCMI_PROTO_BASE_BASE_DISCOVER_VENDOR) | 0x3 |  | See SCMI spec. |
| Base | 0x10 | [BASE_DISCOVER_SUB_VENDOR](@ref SCMI_PROTO_BASE_BASE_DISCOVER_SUB_VENDOR) | 0x4 |  | See SCMI spec. |
| Base | 0x10 | [BASE_DISCOVER_IMPLEMENTATION_VERSION](@ref SCMI_PROTO_BASE_BASE_DISCOVER_IMPLEMENTATION_VERSION) | 0x5 |  | See SCMI spec. |
| Base | 0x10 | [BASE_DISCOVER_LIST_PROTOCOLS](@ref SCMI_PROTO_BASE_BASE_DISCOVER_LIST_PROTOCOLS) | 0x6 |  | See SCMI spec. |
| Base | 0x10 | [BASE_DISCOVER_AGENT](@ref SCMI_PROTO_BASE_BASE_DISCOVER_AGENT) | 0x7 |  | See SCMI spec. |
| Base | 0x10 | [BASE_SET_DEVICE_PERMISSIONS](@ref SCMI_PROTO_BASE_BASE_SET_DEVICE_PERMISSIONS) | 0x9 | PRIV | See SCMI spec. |
| Base | 0x10 | [BASE_RESET_AGENT_CONFIGURATION](@ref SCMI_PROTO_BASE_BASE_RESET_AGENT_CONFIGURATION) | 0xB | PRIV | See SCMI spec. |
| Base | 0x10 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_BASE_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Power | 0x11 | [PROTOCOL_VERSION](@ref SCMI_PROTO_POWER_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Power | 0x11 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_POWER_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Power | 0x11 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_POWER_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Power | 0x11 | [POWER_DOMAIN_ATTRIBUTES](@ref SCMI_PROTO_POWER_POWER_DOMAIN_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Power | 0x11 | [POWER_STATE_SET](@ref SCMI_PROTO_POWER_POWER_STATE_SET) | 0x4 | SET | See SCMI spec. |
| Power | 0x11 | [POWER_STATE_GET](@ref SCMI_PROTO_POWER_POWER_STATE_GET) | 0x5 |  | See SCMI spec. |
| Power | 0x11 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_POWER_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Sys | 0x12 | [PROTOCOL_VERSION](@ref SCMI_PROTO_SYS_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Sys | 0x12 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_SYS_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Sys | 0x12 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_SYS_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Sys | 0x12 | [SYSTEM_POWER_STATE_SET](@ref SCMI_PROTO_SYS_SYSTEM_POWER_STATE_SET) | 0x3 | SET<BR>PRIV<BR>EXCLUSIVE | See SCMI spec. |
| Sys | 0x12 | [SYSTEM_POWER_STATE_NOTIFY](@ref SCMI_PROTO_SYS_SYSTEM_POWER_STATE_NOTIFY) | 0x5 | NOTIFY | See SCMI spec. |
| Sys | 0x12 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_SYS_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Sys\n(notification) | 0x12 | [SYSTEM_POWER_STATE_NOTIFIER](@ref SCMI_PROTO_SYS_SYSTEM_POWER_STATE_NOTIFIER) | 0x0 |  | See SCMI spec. |
| Perf | 0x13 | [PROTOCOL_VERSION](@ref SCMI_PROTO_PERF_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Perf | 0x13 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_PERF_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Perf | 0x13 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_PERF_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_DOMAIN_ATTRIBUTES](@ref SCMI_PROTO_PERF_PERFORMANCE_DOMAIN_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_DESCRIBE_LEVELS](@ref SCMI_PROTO_PERF_PERFORMANCE_DESCRIBE_LEVELS) | 0x4 |  | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_LIMITS_SET](@ref SCMI_PROTO_PERF_PERFORMANCE_LIMITS_SET) | 0x5 | SET | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_LIMITS_GET](@ref SCMI_PROTO_PERF_PERFORMANCE_LIMITS_GET) | 0x6 |  | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_LEVEL_SET](@ref SCMI_PROTO_PERF_PERFORMANCE_LEVEL_SET) | 0x7 | PRIV | See SCMI spec. |
| Perf | 0x13 | [PERFORMANCE_LEVEL_GET](@ref SCMI_PROTO_PERF_PERFORMANCE_LEVEL_GET) | 0x8 |  | See SCMI spec. |
| Perf | 0x13 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_PERF_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Clock | 0x14 | [PROTOCOL_VERSION](@ref SCMI_PROTO_CLOCK_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Clock | 0x14 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_CLOCK_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Clock | 0x14 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_CLOCK_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_ATTRIBUTES](@ref SCMI_PROTO_CLOCK_CLOCK_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_DESCRIBE_RATES](@ref SCMI_PROTO_CLOCK_CLOCK_DESCRIBE_RATES) | 0x4 |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_RATE_SET](@ref SCMI_PROTO_CLOCK_CLOCK_RATE_SET) | 0x5 | EXCLUSIVE | See SCMI spec. |
| Clock | 0x14 | [CLOCK_RATE_GET](@ref SCMI_PROTO_CLOCK_CLOCK_RATE_GET) | 0x6 |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_CONFIG_SET](@ref SCMI_PROTO_CLOCK_CLOCK_CONFIG_SET) | 0x7 | SET | See SCMI spec. |
| Clock | 0x14 | [CLOCK_CONFIG_GET](@ref SCMI_PROTO_CLOCK_CLOCK_CONFIG_GET) | 0xB |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_POSSIBLE_PARENTS_GET](@ref SCMI_PROTO_CLOCK_CLOCK_POSSIBLE_PARENTS_GET) | 0xC |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_PARENT_SET](@ref SCMI_PROTO_CLOCK_CLOCK_PARENT_SET) | 0xD | EXCLUSIVE | See SCMI spec. |
| Clock | 0x14 | [CLOCK_PARENT_GET](@ref SCMI_PROTO_CLOCK_CLOCK_PARENT_GET) | 0xE |  | See SCMI spec. |
| Clock | 0x14 | [CLOCK_GET_PERMISSIONS](@ref SCMI_PROTO_CLOCK_CLOCK_GET_PERMISSIONS) | 0xF |  | See SCMI spec. |
| Clock | 0x14 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_CLOCK_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Sensor | 0x15 | [PROTOCOL_VERSION](@ref SCMI_PROTO_SENSOR_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Sensor | 0x15 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_SENSOR_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Sensor | 0x15 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_SENSOR_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_DESCRIPTION_GET](@ref SCMI_PROTO_SENSOR_SENSOR_DESCRIPTION_GET) | 0x3 |  | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_TRIP_POINT_NOTIFY](@ref SCMI_PROTO_SENSOR_SENSOR_TRIP_POINT_NOTIFY) | 0x4 | NOTIFY | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_TRIP_POINT_CONFIG](@ref SCMI_PROTO_SENSOR_SENSOR_TRIP_POINT_CONFIG) | 0x5 | EXCLUSIVE | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_READING_GET](@ref SCMI_PROTO_SENSOR_SENSOR_READING_GET) | 0x6 |  | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_CONFIG_GET](@ref SCMI_PROTO_SENSOR_SENSOR_CONFIG_GET) | 0x9 |  | See SCMI spec. |
| Sensor | 0x15 | [SENSOR_CONFIG_SET](@ref SCMI_PROTO_SENSOR_SENSOR_CONFIG_SET) | 0xA | SET | See SCMI spec. |
| Sensor | 0x15 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_SENSOR_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Sensor\n(notification) | 0x15 | [SENSOR_TRIP_POINT_EVENT](@ref SCMI_PROTO_SENSOR_SENSOR_TRIP_POINT_EVENT) | 0x0 |  | See SCMI spec. |
| Reset | 0x16 | [PROTOCOL_VERSION](@ref SCMI_PROTO_RESET_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Reset | 0x16 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_RESET_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Reset | 0x16 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_RESET_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Reset | 0x16 | [RESET_DOMAIN_ATTRIBUTES](@ref SCMI_PROTO_RESET_RESET_DOMAIN_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Reset | 0x16 | [RESET](@ref SCMI_PROTO_RESET_RESET) | 0x4 | EXCLUSIVE | See SCMI spec. |
| Reset | 0x16 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_RESET_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Voltage | 0x17 | [PROTOCOL_VERSION](@ref SCMI_PROTO_VOLTAGE_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Voltage | 0x17 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_VOLTAGE_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Voltage | 0x17 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_VOLTAGE_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_DOMAIN_ATTRIBUTES](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_DOMAIN_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_DESCRIBE_LEVELS](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_DESCRIBE_LEVELS) | 0x4 |  | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_CONFIG_SET](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_CONFIG_SET) | 0x5 | SET | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_CONFIG_GET](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_CONFIG_GET) | 0x6 |  | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_LEVEL_SET](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_LEVEL_SET) | 0x7 | EXCLUSIVE | See SCMI spec. |
| Voltage | 0x17 | [VOLTAGE_LEVEL_GET](@ref SCMI_PROTO_VOLTAGE_VOLTAGE_LEVEL_GET) | 0x8 |  | See SCMI spec. |
| Voltage | 0x17 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_VOLTAGE_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PROTOCOL_VERSION](@ref SCMI_PROTO_PINCTRL_PROTOCOL_VERSION) | 0x0 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_PINCTRL_PROTOCOL_ATTRIBUTES) | 0x1 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_PINCTRL_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PINCTRL_ATTRIBUTES](@ref SCMI_PROTO_PINCTRL_PINCTRL_ATTRIBUTES) | 0x3 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PINCTRL_SETTINGS_GET](@ref SCMI_PROTO_PINCTRL_PINCTRL_SETTINGS_GET) | 0x5 |  | See SCMI spec. |
| Pinctrl | 0x19 | [PINCTRL_SETTINGS_CONFIGURE](@ref SCMI_PROTO_PINCTRL_PINCTRL_SETTINGS_CONFIGURE) | 0x6 | EXCLUSIVE | See SCMI spec. |
| Pinctrl | 0x19 | [PINCTRL_REQUEST](@ref SCMI_PROTO_PINCTRL_PINCTRL_REQUEST) | 0x7 | EXCLUSIVE | See SCMI spec. |
| Pinctrl | 0x19 | [PINCTRL_RELEASE](@ref SCMI_PROTO_PINCTRL_PINCTRL_RELEASE) | 0x8 |  | See SCMI spec. |
| Pinctrl | 0x19 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_PINCTRL_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | See SCMI spec. |
| Lmm | 0x80 | [PROTOCOL_VERSION](@ref SCMI_PROTO_LMM_PROTOCOL_VERSION) | 0x0 |  | Mandatory |
...
| Bbm | 0x81 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_BBM_PROTOCOL_ATTRIBUTES) | 0x1 |  | Mandatory |
| Bbm | 0x81 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_BBM_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | Mandatory |
| Bbm | 0x81 | [BBM_GPR_SET](@ref SCMI_PROTO_BBM_BBM_GPR_SET) | 0x3 | EXCLUSIVE | Mandatory if number of GPR not 0. |
| Bbm | 0x81 | [BBM_GPR_GET](@ref SCMI_PROTO_BBM_BBM_GPR_GET) | 0x4 | GET | Mandatory if number of GPR not 0. |
| Bbm | 0x81 | [BBM_RTC_ATTRIBUTES](@ref SCMI_PROTO_BBM_BBM_RTC_ATTRIBUTES) | 0x5 |  | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_RTC_TIME_SET](@ref SCMI_PROTO_BBM_BBM_RTC_TIME_SET) | 0x6 | EXCLUSIVE | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_RTC_TIME_GET](@ref SCMI_PROTO_BBM_BBM_RTC_TIME_GET) | 0x7 |  | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_RTC_ALARM_SET](@ref SCMI_PROTO_BBM_BBM_RTC_ALARM_SET) | 0x8 | PRIV | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_BUTTON_GET](@ref SCMI_PROTO_BBM_BBM_BUTTON_GET) | 0x9 |  | Optional |
| Bbm | 0x81 | [BBM_RTC_NOTIFY](@ref SCMI_PROTO_BBM_BBM_RTC_NOTIFY) | 0xA | NOTIFY | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_BUTTON_NOTIFY](@ref SCMI_PROTO_BBM_BBM_BUTTON_NOTIFY) | 0xB | NOTIFY | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [BBM_RTC_STATE](@ref SCMI_PROTO_BBM_BBM_RTC_STATE) | 0xC |  | Mandatory if number of RTC not 0. |
| Bbm | 0x81 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_BBM_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | Mandatory |
| Bbm\n(notification) | 0x81 | [BBM_RTC_EVENT](@ref SCMI_PROTO_BBM_BBM_RTC_EVENT) | 0x0 |  | Mandatory if number of RTC not 0. |
| Bbm\n(notification) | 0x81 | [BBM_BUTTON_EVENT](@ref SCMI_PROTO_BBM_BBM_BUTTON_EVENT) | 0x1 |  | Optional |
| Cpu | 0x82 | [PROTOCOL_VERSION](@ref SCMI_PROTO_CPU_PROTOCOL_VERSION) | 0x0 |  | Mandatory |
| Cpu | 0x82 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_CPU_PROTOCOL_ATTRIBUTES) | 0x1 |  | Mandatory |
| Cpu | 0x82 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_CPU_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | Mandatory |
| Cpu | 0x82 | [CPU_ATTRIBUTES](@ref SCMI_PROTO_CPU_CPU_ATTRIBUTES) | 0x3 |  | Mandatory |
| Cpu | 0x82 | [CPU_START](@ref SCMI_PROTO_CPU_CPU_START) | 0x4 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_STOP](@ref SCMI_PROTO_CPU_CPU_STOP) | 0x5 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_RESET_VECTOR_SET](@ref SCMI_PROTO_CPU_CPU_RESET_VECTOR_SET) | 0x6 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_SLEEP_MODE_SET](@ref SCMI_PROTO_CPU_CPU_SLEEP_MODE_SET) | 0x7 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_IRQ_WAKE_SET](@ref SCMI_PROTO_CPU_CPU_IRQ_WAKE_SET) | 0x8 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_NON_IRQ_WAKE_SET](@ref SCMI_PROTO_CPU_CPU_NON_IRQ_WAKE_SET) | 0x9 | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_PD_LPM_CONFIG_SET](@ref SCMI_PROTO_CPU_CPU_PD_LPM_CONFIG_SET) | 0xA | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_PER_LPM_CONFIG_SET](@ref SCMI_PROTO_CPU_CPU_PER_LPM_CONFIG_SET) | 0xB | EXCLUSIVE | Mandatory |
| Cpu | 0x82 | [CPU_INFO_GET](@ref SCMI_PROTO_CPU_CPU_INFO_GET) | 0xC |  | Mandatory |
| Cpu | 0x82 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_CPU_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | Mandatory |
| Fusa | 0x83 | [PROTOCOL_VERSION](@ref SCMI_PROTO_FUSA_PROTOCOL_VERSION) | 0x0 |  | Mandatory |
| Fusa | 0x83 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_FUSA_PROTOCOL_ATTRIBUTES) | 0x1 |  | Mandatory |
| Fusa | 0x83 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_FUSA_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | Mandatory |
| Fusa | 0x83 | [FUSA_FEENV_STATE_GET](@ref SCMI_PROTO_FUSA_FUSA_FEENV_STATE_GET) | 0x3 | GET | Mandatory |
| Fusa | 0x83 | [FUSA_FEENV_STATE_NOTIFY](@ref SCMI_PROTO_FUSA_FUSA_FEENV_STATE_NOTIFY) | 0x5 | NOTIFY | Mandatory |
| Fusa | 0x83 | [FUSA_SEENV_STATE_GET](@ref SCMI_PROTO_FUSA_FUSA_SEENV_STATE_GET) | 0x6 |  | Mandatory |
| Fusa | 0x83 | [FUSA_SEENV_STATE_SET](@ref SCMI_PROTO_FUSA_FUSA_SEENV_STATE_SET) | 0x7 |  | Mandatory |
| Fusa | 0x83 | [FUSA_FAULT_GET](@ref SCMI_PROTO_FUSA_FUSA_FAULT_GET) | 0x8 | GET | Mandatory |
| Fusa | 0x83 | [FUSA_FAULT_SET](@ref SCMI_PROTO_FUSA_FUSA_FAULT_SET) | 0x9 | EXCLUSIVE | Mandatory |
| Fusa | 0x83 | [FUSA_FAULT_GROUP_NOTIFY](@ref SCMI_PROTO_FUSA_FUSA_FAULT_GROUP_NOTIFY) | 0xA | NOTIFY | Mandatory |
| Fusa | 0x83 | [FUSA_SCHECK_EVNTRIG](@ref SCMI_PROTO_FUSA_FUSA_SCHECK_EVNTRIG) | 0xB |  | Mandatory |
| Fusa | 0x83 | [FUSA_SCHECK_TEST_EXEC](@ref SCMI_PROTO_FUSA_FUSA_SCHECK_TEST_EXEC) | 0xE | SET | Mandatory |
| Fusa | 0x83 | [NEGOTIATE_PROTOCOL_VERSION](@ref SCMI_PROTO_FUSA_NEGOTIATE_PROTOCOL_VERSION) | 0x10 |  | Mandatory |
| Fusa\n(notification) | 0x83 | [FUSA_FEENV_STATE_EVENT](@ref SCMI_PROTO_FUSA_FUSA_FEENV_STATE_EVENT) | 0x0 |  | Mandatory |
| Fusa\n(notification) | 0x83 | [FUSA_SEENV_STATE_REQ_EVENT](@ref SCMI_PROTO_FUSA_FUSA_SEENV_STATE_REQ_EVENT) | 0x1 |  | Mandatory |
| Fusa\n(notification) | 0x83 | [FUSA_FAULT_EVENT](@ref SCMI_PROTO_FUSA_FUSA_FAULT_EVENT) | 0x2 |  | Mandatory |
| Misc | 0x84 | [PROTOCOL_VERSION](@ref SCMI_PROTO_MISC_PROTOCOL_VERSION) | 0x0 |  | Mandatory |
| Misc | 0x84 | [PROTOCOL_ATTRIBUTES](@ref SCMI_PROTO_MISC_PROTOCOL_ATTRIBUTES) | 0x1 |  | Mandatory |
| Misc | 0x84 | [PROTOCOL_MESSAGE_ATTRIBUTES](@ref SCMI_PROTO_MISC_PROTOCOL_MESSAGE_ATTRIBUTES) | 0x2 |  | Mandatory |
| Misc | 0x84 | [MISC_CONTROL_SET](@ref SCMI_PROTO_MISC_MISC_CONTROL_SET) | 0x3 | EXCLUSIVE | Mandatory if number of controls not 0. |
| Misc | 0x84 | [MISC_CONTROL_GET](@ref SCMI_PROTO_MISC_MISC_CONTROL_GET) | 0x4 | GET | Mandatory if number of controls not 0. |
| Misc | 0x84 | [MISC_CONTROL_ACTION](@ref SCMI_PROTO_MISC_MISC_CONTROL_ACTION) | 0x5 | EXCLUSIVE | Mandatory if number of controls not 0. |
| Misc | 0x84 | [MISC_DISCOVER_BUILD_INFO](@ref SCMI_PROTO_MISC_MISC_DISCOVER_BUILD_INFO) | 0x6 |  | Mandatory |
| Misc | 0x84 | [MISC_ROM_PASSOVER_GET](@ref SCMI_PROTO_MISC_MISC_ROM_PASSOVER_GET) | 0x7 |  | Optional |
| Misc | 0x84 | [MISC_CONTROL_NOTIFY](@ref SCMI_PROTO_MISC_MISC_CONTROL_NOTIFY) | 0x8 | NOTIFY | Mandatory if number of controls not 0. |
| Misc | 0x84 | [MISC_REASON_ATTRIBUTES](@ref SCMI_PROTO_MISC_MISC_REASON_ATTRIBUTES) | 0x9 |  | Mandatory |
| Misc | 0x84 | [MISC_RESET_REASON](@ref SCMI_PROTO_MISC_MISC_RESET_REASON) | 0xA |  | Mandatory |
| Misc | 0x84 | [MISC_SI_INFO](@ref SCMI_PROTO_MISC_MISC_SI_INFO) | 0xB |  | Mandatory |
| Misc | 0x84 | [MISC_CFG_INFO](@ref SCMI_PROTO_MISC_MISC_CFG_INFO) | 0xC |  | Mandatory |
| Misc | 0x84 | [MISC_SYSLOG](@ref SCMI_PROTO_MISC_MISC_SYSLOG) | 0xD |  | Mandatory |
| Misc | 0x84 | [MISC_BOARD_INFO](@ref SCMI_PROTO_MISC_MISC_BOARD_INFO) | 0xE |  | Mandatory |
