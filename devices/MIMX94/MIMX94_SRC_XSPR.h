...
/*!
 * @file MIMX9494_SRC_XSPR.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for MIMX9494_SRC_XSPR
 *
 * CMSIS Peripheral Access Layer for MIMX9494
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX9494_SRC_XSPR_H_)  /* Check if memory map has not been already included */
#define MIMX9494_SRC_XSPR_H_
...
#define SRC_XSPR_A55_HDSK_ACK_CTRL_A55_HDSK_CTRL_SW_MASK (0x400U)
#define SRC_XSPR_A55_HDSK_ACK_CTRL_A55_HDSK_CTRL_SW_SHIFT (10U)
/*! A55_HDSK_CTRL_SW - A55 handshake CTRL SW. Locked by LOCK_CFG field. */
#define SRC_XSPR_A55_HDSK_ACK_CTRL_A55_HDSK_CTRL_SW(x) (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_A55_HDSK_ACK_CTRL_A55_HDSK_CTRL_SW_SHIFT)) & SRC_XSPR_A55_HDSK_ACK_CTRL_A55_HDSK_CTRL_SW_MASK)
...
#define SRC_XSPR_MTR_ACK_CTRL_MTR_CNT_CFG_MASK   (0xFFU)
#define SRC_XSPR_MTR_ACK_CTRL_MTR_CNT_CFG_SHIFT  (0U)
/*! MTR_CNT_CFG - MTR count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define SRC_XSPR_MTR_ACK_CTRL_MTR_CNT_CFG(x)     (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_MTR_ACK_CTRL_MTR_CNT_CFG_SHIFT)) & SRC_XSPR_MTR_ACK_CTRL_MTR_CNT_CFG_MASK)

#define SRC_XSPR_MTR_ACK_CTRL_CNT_MODE_MASK      (0xC0000000U)
#define SRC_XSPR_MTR_ACK_CTRL_CNT_MODE_SHIFT     (30U)
/*! CNT_MODE - Configure the acknowledge counter working mode. Locked by LOCK_CFG field.
 ...
 */
#define SRC_XSPR_MTR_ACK_CTRL_CNT_MODE(x)        (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_MTR_ACK_CTRL_CNT_MODE_SHIFT)) & SRC_XSPR_MTR_ACK_CTRL_CNT_MODE_MASK)
/*! @} */

/*! @name MTR_ACK_STAT - MTR acknowledge status */
/*! @{ */

#define SRC_XSPR_MTR_ACK_STAT_MTR_ACK_CNT_MASK   (0xFFU)
#define SRC_XSPR_MTR_ACK_STAT_MTR_ACK_CNT_SHIFT  (0U)
/*! MTR_ACK_CNT - MTR acknowledge count, record the delay from stat change to acknowledge received */
#define SRC_XSPR_MTR_ACK_STAT_MTR_ACK_CNT(x)     (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_MTR_ACK_STAT_MTR_ACK_CNT_SHIFT)) & SRC_XSPR_MTR_ACK_STAT_MTR_ACK_CNT_MASK)

#define SRC_XSPR_MTR_ACK_STAT_MTR_DONE_MASK      (0x40000000U)
#define SRC_XSPR_MTR_ACK_STAT_MTR_DONE_SHIFT     (30U)
/*! MTR_DONE - Indicate MTR load repair finished */
#define SRC_XSPR_MTR_ACK_STAT_MTR_DONE(x)        (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_MTR_ACK_STAT_MTR_DONE_SHIFT)) & SRC_XSPR_MTR_ACK_STAT_MTR_DONE_MASK)

#define SRC_XSPR_MTR_ACK_STAT_BUSY_MTR_MASK      (0x80000000U)
#define SRC_XSPR_MTR_ACK_STAT_BUSY_MTR_SHIFT     (31U)
/*! BUSY_MTR - Busy requesting MTR */
#define SRC_XSPR_MTR_ACK_STAT_BUSY_MTR(x)        (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_MTR_ACK_STAT_BUSY_MTR_SHIFT)) & SRC_XSPR_MTR_ACK_STAT_BUSY_MTR_MASK)
/*! @} */
...
#define SRC_XSPR_UPI_STAT_2_UPI_MTR_REQUEST_MASK (0xFFFFU)
#define SRC_XSPR_UPI_STAT_2_UPI_MTR_REQUEST_SHIFT (0U)
/*! UPI_MTR_REQUEST - CPU mode trans mtr request of 16 domains */
#define SRC_XSPR_UPI_STAT_2_UPI_MTR_REQUEST(x)   (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_UPI_STAT_2_UPI_MTR_REQUEST_SHIFT)) & SRC_XSPR_UPI_STAT_2_UPI_MTR_REQUEST_MASK)
...
#define SRC_XSPR_FSM_STAT_MTR_STAT_MASK          (0x7000U)
#define SRC_XSPR_FSM_STAT_MTR_STAT_SHIFT         (12U)
/*! MTR_STAT - MTR FSM status */
#define SRC_XSPR_FSM_STAT_MTR_STAT(x)            (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_FSM_STAT_MTR_STAT_SHIFT)) & SRC_XSPR_FSM_STAT_MTR_STAT_MASK)

#define SRC_XSPR_FSM_STAT_RST_STAT_BIT4_MASK     (0x8000U)
#define SRC_XSPR_FSM_STAT_RST_STAT_BIT4_SHIFT    (15U)
/*! RST_STAT_BIT4 - Reset FSM status Bit4 */
#define SRC_XSPR_FSM_STAT_RST_STAT_BIT4(x)       (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_FSM_STAT_RST_STAT_BIT4_SHIFT)) & SRC_XSPR_FSM_STAT_RST_STAT_BIT4_MASK)
...
#define SRC_XSPR_FUNC_STAT_MTR_STAT_MASK         (0x40U)
#define SRC_XSPR_FUNC_STAT_MTR_STAT_SHIFT        (6U)
/*! MTR_STAT - MTR status
 *  0b0..No effect
 *  0b1..Memory repair/trim done
 */
#define SRC_XSPR_FUNC_STAT_MTR_STAT(x)           (((uint32_t)(((uint32_t)(x)) << SRC_XSPR_FUNC_STAT_MTR_STAT_SHIFT)) & SRC_XSPR_FUNC_STAT_MTR_STAT_MASK)
...
/* SRC_XSPR - Peripheral instance base addresses */
  ...
  #define SRC_XSPR_BASE_ADDRS                      { SRC_XSPR_ANAMIX_BASE, SRC_XSPR_AONMIX_BASE, SRC_XSPR_BBSMMIX_BASE, SRC_XSPR_M71MIX_BASE, SRC_XSPR_CCMSRCGPCMIX_BASE, SRC_XSPR_CORTEXMIX_CORE0_BASE, SRC_XSPR_CORTEXMIX_CORE1_BASE, SRC_XSPR_CORTEXMIX_CORE2_BASE, SRC_XSPR_CORTEXMIX_CORE3_BASE, SRC_XSPR_CORTEXMIX_PLATFORM_BASE, SRC_XSPR_DDRMIX_BASE, SRC_XSPR_DISPLAYMIX_BASE, SRC_XSPR_M70MIX_BASE, SRC_XSPR_HSIOMIX_TOP_BASE, SRC_XSPR_HSIOMIX_WAON_BASE, SRC_XSPR_NETCMIX_BASE, SRC_XSPR_NOCMIX_BASE, SRC_XSPR_NPUMIX_BASE, SRC_XSPR_WAKEUPMIX_BASE }
  /** Array initializer of SRC_XSPR peripheral base pointers */
  #define SRC_XSPR_BASE_PTRS                       { SRC_XSPR_ANAMIX, SRC_XSPR_AONMIX, SRC_XSPR_BBSMMIX, SRC_XSPR_M71MIX, SRC_XSPR_CCMSRCGPCMIX, SRC_XSPR_CORTEXMIX_CORE0, SRC_XSPR_CORTEXMIX_CORE1, SRC_XSPR_CORTEXMIX_CORE2, SRC_XSPR_CORTEXMIX_CORE3, SRC_XSPR_CORTEXMIX_PLATFORM, SRC_XSPR_DDRMIX, SRC_XSPR_DISPLAYMIX, SRC_XSPR_M70MIX, SRC_XSPR_HSIOMIX_TOP, SRC_XSPR_HSIOMIX_WAON, SRC_XSPR_NETCMIX, SRC_XSPR_NOCMIX, SRC_XSPR_NPUMIX, SRC_XSPR_WAKEUPMIX }
  /** Array initializer of SRC_XSPR peripheral base addresses */
  #define SRC_XSPR_BASE_ADDRS_NS                   { SRC_XSPR_ANAMIX_BASE_NS, SRC_XSPR_AONMIX_BASE_NS, SRC_XSPR_BBSMMIX_BASE_NS, SRC_XSPR_M71MIX_BASE_NS, SRC_XSPR_CCMSRCGPCMIX_BASE_NS, SRC_XSPR_CORTEXMIX_CORE0_BASE_NS, SRC_XSPR_CORTEXMIX_CORE1_BASE_NS, SRC_XSPR_CORTEXMIX_CORE2_BASE_NS, SRC_XSPR_CORTEXMIX_CORE3_BASE_NS, SRC_XSPR_CORTEXMIX_PLATFORM_BASE_NS, SRC_XSPR_DDRMIX_BASE_NS, SRC_XSPR_DISPLAYMIX_BASE_NS, SRC_XSPR_M70MIX_BASE_NS, SRC_XSPR_HSIOMIX_TOP_BASE_NS, SRC_XSPR_HSIOMIX_WAON_BASE_NS, SRC_XSPR_NETCMIX_BASE_NS, SRC_XSPR_NOCMIX_BASE_NS, SRC_XSPR_NPUMIX_BASE_NS, SRC_XSPR_WAKEUPMIX_BASE_NS }
  /** Array initializer of SRC_XSPR peripheral base pointers */
  #define SRC_XSPR_BASE_PTRS_NS                    { SRC_XSPR_ANAMIX_NS, SRC_XSPR_AONMIX_NS, SRC_XSPR_BBSMMIX_NS, SRC_XSPR_M71MIX_NS, SRC_XSPR_CCMSRCGPCMIX_NS, SRC_XSPR_CORTEXMIX_CORE0_NS, SRC_XSPR_CORTEXMIX_CORE1_NS, SRC_XSPR_CORTEXMIX_CORE2_NS, SRC_XSPR_CORTEXMIX_CORE3_NS, SRC_XSPR_CORTEXMIX_PLATFORM_NS, SRC_XSPR_DDRMIX_NS, SRC_XSPR_DISPLAYMIX_NS, SRC_XSPR_M70MIX_NS, SRC_XSPR_HSIOMIX_TOP_NS, SRC_XSPR_HSIOMIX_WAON_NS, SRC_XSPR_NETCMIX_NS, SRC_XSPR_NOCMIX_NS, SRC_XSPR_NPUMIX_NS, SRC_XSPR_WAKEUPMIX_NS }
#else
  /** Peripheral SRC_XSPR_ANAMIX base address */
...
#endif  /* #if !defined(MIMX9494_SRC_XSPR_H_) */
