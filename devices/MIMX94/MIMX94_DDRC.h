 ...
 * @version
 * @date
 * @brief CMSIS Peripheral Access Layer for MIMX94_DDRC
 *
 * CMSIS Peripheral Access Layer for MIMX94
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX94_DDRC_H_)  /* Check if memory map has not been already included */
#define MIMX94_DDRC_H_
...
#endif  /* #if !defined(MIMX94_DDRC_H_) */
