...
/*!
 * @file MIMX9494_LPUART.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for MIMX9494_LPUART
 *
 * CMSIS Peripheral Access Layer for MIMX9494
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX9494_LPUART_H_)  /* Check if memory map has not been already included */
#define MIMX9494_LPUART_H_
...
#endif  /* #if !defined(MIMX9494_LPUART_H_) */
