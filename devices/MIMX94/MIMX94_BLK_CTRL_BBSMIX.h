...
/*!
 * @file MIMX94_BLK_CTRL_BBSMIX.h
 * @version 0.0
 * @date 0-00-00
 * @brief CMSIS Peripheral Access Layer for MIMX94_BLK_CTRL_BBSMIX
 *
 * CMSIS Peripheral Access Layer for MIMX94
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX94_BLK_CTRL_BBSMIX_H_)  /* Check if memory map has not been already included */
#define MIMX94_BLK_CTRL_BBSMIX_H_
...
#endif  /* #if !defined(MIMX94_BLK_CTRL_BBSMIX_H_) */
