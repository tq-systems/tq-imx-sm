/*
** ###################################################################
**     Processors:          IMX94_cm33
**
**
**     Abstract:
**         CMSIS Peripheral Access Layer for IMX94_cm33
**
 ...
 * @version
 * @date
 * @brief CMSIS Peripheral Access Layer for IMX94_GICR
 *
 * CMSIS Peripheral Access Layer for IMX94
 */

/* Prevention from multiple including the same memory map */
#if !defined(IMX94_GICR_H_)  /* Check if memory map has not been already included */
#define IMX94_GICR_H_
...
#endif  /* #if !defined(IMX94_GICR_H_) */
