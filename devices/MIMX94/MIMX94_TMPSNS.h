...
/*!
 * @file MIMX9494_TMPSNS.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for MIMX9494_TMPSNS
 *
 * CMSIS Peripheral Access Layer for MIMX9494
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX9494_TMPSNS_H_)  /* Check if memory map has not been already included */
#define MIMX9494_TMPSNS_H_
...
/* TMPSNS - Peripheral instance base addresses */
  ...
  #define TMPSNS_BASE_ADDRS                        { TMPSNS_BASE, CORTEXA__TMPSNS_BASE }
  /** Array initializer of TMPSNS peripheral base pointers */
  #define TMPSNS_BASE_PTRS                         { TMPSNS, CORTEXA__TMPSNS }
  /** Array initializer of TMPSNS peripheral base addresses */
  #define TMPSNS_BASE_ADDRS_NS                     { TMPSNS_BASE_NS, CORTEXA__TMPSNS_BASE_NS }
  /** Array initializer of TMPSNS peripheral base pointers */
  #define TMPSNS_BASE_PTRS_NS                      { TMPSNS_NS, CORTEXA__TMPSNS_NS }
#else
  /** Peripheral TMPSNS base address */
...
#endif  /* #if !defined(MIMX9494_TMPSNS_H_) */
