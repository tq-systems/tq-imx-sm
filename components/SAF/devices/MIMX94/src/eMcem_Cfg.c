...
const eMcem_CVfccuInstanceCfgType CVfccuCfg =
{
    ...
    /* ---------------------------------------- */
    {
        ...
        { /*!< Immediate Reaction Set */
            (uint32)0x0004UL,    /*!< Assert FCCU IRQ 0 */
            (uint32)0x0008UL,    /*!< Assert FCCU IRQ 1 */
            (uint32)0x0010UL,    /*!< Assert FCCU IRQ 2 */
            (uint32)0x0004UL,    /*!< Assert FCCU IRQ 0 */
            (uint32)0x0008UL,    /*!< Assert FCCU IRQ 1 */
            (uint32)0x0010UL,    /*!< Assert FCCU IRQ 2 */
            (uint32)0x0000UL,    /*!< None */
            (uint32)0x0002UL,    /*!< PMIC reset (assert EOUT1) */
        },
        { /*!< Delayed Reaction Set */
            (uint32)0x0002UL,    /*!< PMIC reset (assert EOUT1) */
            (uint32)0x0002UL,    /*!< PMIC reset (assert EOUT1) */
            (uint32)0x0002UL,    /*!< PMIC reset (assert EOUT1) */
            (uint32)0x1000UL,    /*!< SRC reset */
            (uint32)0x1000UL,    /*!< SRC reset */
            (uint32)0x1000UL,    /*!< SRC reset */
            (uint32)0x0002UL,    /*!< PMIC reset (assert EOUT1) */
            (uint32)0x0002UL     /*!< PMIC reset (assert EOUT1) */
