/**************************************************************************
 * FILE NAME: SafetyBase_MIMX943X_SAF.h                                   *
 * REVISION:  1.0                                                         *
 *                                                                        *
 * DESCRIPTION:                                                           *
 ...
 * 1       nxf49771   14-Feb-2025   Clean up structure usage for each env *
 *                                                                        *
 *========================================================================*
...
#ifndef _SafetyBase_MIMX943X_SAF_H_
#define _SafetyBase_MIMX943X_SAF_H_
#include "Std_Types.h"
#ifdef __cplusplus
extern "C" {
#endif
...
#define TRDC_AON_MRC_MAX_NUM            (1U)
#define TRDC_AON_MBC_MAX_NUM            (2U)
...
typedef union TRDC_DERR_W0_union_tag { /* MBC/MRC Domain Error Word0 Register */
  volatile uint32 R;
  struct {
    volatile uint32 EADDR:32;                /* Error address */
  } B;
} TRDC_DERR_W0_tag;

typedef union TRDC_DERR_W1_union_tag { /* MBC/MRC Domain Error Word1 Register */
  volatile uint32 R;
  struct {
...
typedef struct TRDC_MBC_DERR_struct_tag {
  ...
  TRDC_DERR_W1_tag W1;     /* MBC/MRC Domain Error Word1 Register */
  uint8 DERR_reserved0[4];
  TRDC_DERR_W3_tag W3;     /* MBC/MRC Domain Error Word3 Register */
} TRDC_DERR_tag;

typedef union TRDC_PID16_union_tag { /* Process Identifier */
  volatile uint32 R;
  struct {
...
typedef union TRDC_MRC_DOM0_RGD_W0_union_tag { /* MRC Region Descriptor Word 0 */
  ...
  struct {
    ...
    volatile uint32 _unused_18:11;
    volatile uint32 STRT_ADDR:18;            /* Start Address */
  } B;
...
typedef union TRDC_MRC_DOM_RGD_W1_union_tag { /* MRC Region Descriptor Word 1 */
  ...
  struct {
    ...
    volatile uint32 _unused_18:9;
    volatile uint32 END_ADDR:18;             /* End Address */
  } B;
...
struct TRDC_tag {
  ...
  TRDC_MBC_tag MBC[TRDC_AON_MBC_MAX_NUM];           /* MBC configuration and domain registers */

  TRDC_MRC_tag MRC[TRDC_AON_MRC_MAX_NUM];           /* MRC configuration and domain registers */
};
...
typedef union LSTCU_ERR_STAT_union_tag { /* Error Status */
  volatile uint32 R;
  struct {
    volatile uint32 INVP_FB:1;               /* Invalid Pointer FBIST */
    volatile uint32 INVP_MB:1;               /* Invalid Pointer MBIST */
    volatile uint32 INVP_LB:1;               /* Invalid Pointer LBIST */
...
typedef union LSTCU_ERR_FM_union_tag { /* Error Fault Mapping */
  volatile uint32 R;
  struct {
    volatile uint32 INVPFMFB:1;              /* Invalid BIST Pointer Fault Mapping During FBIST Scheduling */
    volatile uint32 INVPFMMB:1;              /* Invalid BIST Pointer Fault Mapping During MBIST Scheduling */
    volatile uint32 INVPFMLB:1;              /* Invalid BIST Pointer Fault Mapping During LBIST Scheduling */
...
typedef union LSTCU_DBGCTRL_union_tag { /* Debug Control */
  volatile uint32 R;
  struct {
    volatile uint32 MUX_SEL:1;               /* Debug Selector */
    volatile uint32 _unused_0:31;
  } B;
} LSTCU_DBGCTRL_tag;
...
typedef union LSTCU_DBGSTAT_union_tag { /* Debug Status */
  volatile uint32 R;
  struct {
    volatile uint32 DBG_STAT:32;             /* Debug Status */
  } B;
} LSTCU_DBGSTAT_tag;
...
struct LSTCU_tag {
  ...
  uint8 DDR_LSTCU_reserved6[44];
  LSTCU_DBGCTRL_tag DBGCTRL;       /* Debug Control */
  uint8 DDR_LSTCU_reserved7[4];
  LSTCU_DBGSTAT_tag DBGSTAT;       /* Debug Status */
  uint8 DDR_LSTCU_reserved8[84];
...
#define CMU_M1_1 (*(volatile struct CMU_tag *) 0x4AC80000UL)
#define CMU_M2_1 (*(volatile struct CMU_tag *) 0x4AC90000UL)
...
/* ================== Common definitions ================== */
#define M7__A7_MCM1 (*(volatile struct M7_A7_MCM_tag *) 0x4A0A0000UL)
#define M7_1__A7_MCM1 (*(volatile struct M7_A7_MCM_tag *) 0x49CA0000UL)
#define CMU_M1 (*(volatile struct CMU_tag *) 0x4A080000UL)
#define CMU_M2 (*(volatile struct CMU_tag *) 0x4A090000UL)
...
#endif
#endif /* ifdef _SafetyBase_MIMX943X_SAF_H_ */
